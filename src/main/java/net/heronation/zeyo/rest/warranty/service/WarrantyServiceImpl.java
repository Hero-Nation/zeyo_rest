...
public class WarrantyServiceImpl implements WarrantyService {
	...
	public Map<String, Object> search(Map<String, Object> param, Pageable page) {
		...
		//
		// PathBuilder<Warranty> queryPath = new PathBuilder<Warranty>(Warranty.class,
		// "warranty");
		//
		...
		//
		// QueryResults<Tuple> R = query.select(w.id, w.scope, w.kindof.kvalue,
		// w.createDt, i.id.countDistinct())
		// .from(w)
		// .where(where)
		...
		// page.getPageSize()).limit(page.getPageSize())
		// .fetchResults();
		//
