...
import net.heronation.zeyo.rest.item.repository.Item;import net.heronation.zeyo.rest.kindof.repository.Kindof;import net.heronation.zeyo.rest.material.repository.Material;
...
private String useYn;
	...
	public String toString() {
		StringBuilder builder = new StringBuilder(); 
                .append("  ItemMaterialMap  Entity  ")
                .append("\n id  =  ").append(id)

.append("\n contain  =  ").append(contain)
