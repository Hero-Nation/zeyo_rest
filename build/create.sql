...
create table consumer (id bigint not null, access_token varchar(255), corp_id varchar(255), corp_type varchar(255), create_dt datetime, delete_dt datetime, last_access_dt datetime, now_ip varchar(255), now_product_id varchar(255), now_shop_id varchar(255), now_shop_type varchar(255), oauth_code varchar(255), oauth_id varchar(255), refresh_token varchar(255), use_yn varchar(255), primary key (id))
...
create table ip_temp_info (id bigint not null, ip varchar(255), product_id varchar(255), shop_id varchar(255), shop_type varchar(255), primary key (id))
