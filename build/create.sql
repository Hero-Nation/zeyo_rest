...
create table brand (id bigint not null, create_dt datetime, name varchar(255), use_yn varchar(255), member_id bigint, primary key (id))
...
create table member (id bigint not null, admin_yn varchar(255), confirm_no varchar(255), create_dt datetime, delete_dt datetime, email varchar(255), manager varchar(255), manager_email varchar(255), manager_phone varchar(255), member_id varchar(255), name varchar(255), password varchar(255), phone varchar(255), use_yn varchar(255), company_no_history_id bigint, primary key (id))
create table shopmall (id bigint not null, create_dt datetime, name varchar(255), use_yn varchar(255), member_id bigint, primary key (id))
