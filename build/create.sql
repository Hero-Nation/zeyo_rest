...
create table dmodel (id bigint not null, controller varchar(255), create_dt datetime, svgdata varchar(255), title varchar(255), update_dt datetime, use_yn varchar(255), primary key (id))
create table dmodel_measure_map (id bigint not null, max_value varchar(255), min_value varchar(255), use_yn varchar(255), dmodel_id bigint, measure_item_id bigint, primary key (id))
create table dmodel_ratio (id bigint not null, default_yn varchar(255), max_value varchar(255), min_value varchar(255), ratio_value varchar(255), use_yn varchar(255), dmodel_id bigint, primary key (id))
...
create table v2_rule (id bigint not null, create_dt datetime, first_include_child varchar(255), rule_message varchar(255), rule_type varchar(255), second_include_child varchar(255), title varchar(255), use_yn varchar(255), first_ct bigint, second_ct bigint, primary key (id))
...
alter table dmodel_measure_map add constraint FKkbycmdy4esfstn3q5rf0hqfu3 foreign key (dmodel_id) references dmodel (id)
alter table dmodel_measure_map add constraint FKhsgji8xbeg3hhxe9uuwextelb foreign key (measure_item_id) references measure_item (id)
alter table dmodel_ratio add constraint FK89n4aodwxte6syakhkxq5j673 foreign key (dmodel_id) references dmodel (id)
...
alter table sub_category add constraint FKat0x4w57eu0x190su9cdy2jsi foreign key (dmodel_id) references dmodel (id)
...
alter table v2_rule add constraint FKfpub1f0g16p9435d0vysawki6 foreign key (first_ct) references sub_category (id)
alter table v2_rule add constraint FKkubs2715wcfqiw0n752crc0g5 foreign key (second_ct) references sub_category (id)
