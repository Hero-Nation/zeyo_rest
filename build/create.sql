...
create table shopmall (id bigint not null, create_dt datetime, name varchar(255), size_cp_yn varchar(255), use_yn varchar(255), member_id bigint, primary key (id))
