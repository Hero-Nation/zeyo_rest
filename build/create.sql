...
create table shopmall (id bigint not null, access_token varchar(255), create_dt datetime, delete_dt datetime, name varchar(255), oauth_code varchar(255), refresh_token varchar(255), store_id varchar(255), store_type varchar(255), temp_identity varchar(255), use_yn varchar(255), member_id bigint, primary key (id))
