create table bbs (id bigint not null, bbs_content varchar(255), create_dt tinyblob, reply_content varchar(255), reply_dt tinyblob, status varchar(255), title varchar(255), use_yn varchar(255), kindof_id bigint, member_id bigint, primary key (id))
create table brand (id bigint not null, create_dt tinyblob, name varchar(255), use_yn varchar(255), member_id bigint, primary key (id))
create table category (id bigint not null, create_dt tinyblob, name varchar(255), use_yn varchar(255), primary key (id))
create table cloth_color (id bigint not null, name varchar(255), use_yn varchar(255), kindof_id bigint, primary key (id))
create table company_no_history (id bigint not null, before_no varchar(255), change_dt tinyblob, company_no varchar(255), name varchar(255), member_id bigint, primary key (id))
create table fit_info (id bigint not null, create_dt tinyblob, meta_desc varchar(255), name varchar(255), use_yn varchar(255), primary key (id))
create table fit_info_option (id bigint not null, name varchar(255), use_yn varchar(255), fit_info_id bigint, primary key (id))
create table item (id bigint not null, bleach_yn varchar(255), code varchar(255), create_dt tinyblob, drycleaning_yn varchar(255), drymethod_yn varchar(255), image varchar(255), image_mode varchar(255), ironing_yn varchar(255), laundry_yn varchar(255), link_yn varchar(255), madein_builder varchar(255), madein_date tinyblob, name varchar(255), price integer not null, size_measure_image varchar(255), size_measure_mode varchar(255), size_table_yn varchar(255), use_yn varchar(255), brand_id bigint, category_id bigint, madein_id bigint, member_id bigint, sub_category_id bigint, warranty_id bigint, primary key (id))
...
create table item_cloth_color_map (id bigint not null, use_yn varchar(255), cloth_color_id bigint, item_id bigint, primary key (id))
...
create table item_fit_info_option_map (id bigint not null, last_modified_date tinyblob, use_yn varchar(255), version bigint, fit_info_option_id bigint, item_id bigint, primary key (id))
...
create table item_material_map (id bigint not null, contain varchar(255), use_yn varchar(255), item_id bigint, kindof_id bigint, material_id bigint, primary key (id))
...
create table material (id bigint not null, create_dt tinyblob, image varchar(255), meta_desc varchar(255), name varchar(255), use_yn varchar(255), primary key (id))
create table measure_item (id bigint not null, create_dt tinyblob, meta_desc varchar(255), name varchar(255), use_yn varchar(255), primary key (id))
create table member (id bigint not null, admin_yn varchar(255), create_dt tinyblob, delete_dt tinyblob, email varchar(255), manager varchar(255), manager_email varchar(255), manager_phone varchar(255), member_id varchar(255), name varchar(255), password varchar(255), phone varchar(255), use_yn varchar(255), company_no_history_id bigint, primary key (id))
create table shopmall (id bigint not null, create_dt tinyblob, name varchar(255), size_cp_yn varchar(255), use_yn varchar(255), member_id bigint, primary key (id))
create table size_option (id bigint not null, create_dt tinyblob, name varchar(255), use_yn varchar(255), category_id bigint, kindof_id bigint, sub_category_id bigint, primary key (id))
create table size_table (id bigint not null, create_dt tinyblob, last_modified_date tinyblob, use_yn varchar(255), version bigint, visible_basic_yn varchar(255), visible_code_yn varchar(255), visible_color_yn varchar(255), visible_fit_info_yn varchar(255), visible_item_image_yn varchar(255), visible_laundry_info_yn varchar(255), visible_measure_howayn varchar(255), visible_measure_howbyn varchar(255), visible_measure_table_yn varchar(255), visible_name_yn varchar(255), item_id bigint, primary key (id))
create table sub_category (id bigint not null, bleach_yn varchar(255), cloth_image varchar(255), create_dt tinyblob, drycleaning_yn varchar(255), drymethod_yn varchar(255), ironing_yn varchar(255), item_image varchar(255), laundry_yn varchar(255), name varchar(255), use_yn varchar(255), category_id bigint, primary key (id))
...
create table warranty (id bigint not null, create_dt tinyblob, scope varchar(255), use_yn varchar(255), kindof_id bigint, primary key (id))
