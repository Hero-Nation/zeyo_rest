...
create table item_material_map (id bigint not null, contain varchar(255), use_locatoin varchar(255), use_yn varchar(255), item_id bigint, kindof_id bigint, material_id bigint, primary key (id))
