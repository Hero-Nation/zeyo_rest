...
alter table fit_into_choice drop foreign key FKsl0yj5q6ps9v6blss8aateoqq
alter table fit_into_choice drop foreign key FKp91whe2lbpia2vhok24h7hh0v
...
drop table if exists fit_into_choice
